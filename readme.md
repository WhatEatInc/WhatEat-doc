...
Nous avons décider d'utiliser VSCode comme IDE avec Node.js et NPM pour l'execution dut JS et la gestion des dépendances. Nous avons aussi installer git pour pouvoir envoyer le code vers Github.
