...
- Serveur Heroku
   - Après avoir comparé avec plusieurs service d'hébergement de site web nous sommes parti sur Heroku, il est simple à utiliser et gratuit pour les projets non commercial. Nous avons mis le backend dessus.
